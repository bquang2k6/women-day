...
const messages = [
    ...
    "biết gì không ?",
    "bật mí cho cậu biết" ,
    "Cậu là người đầu tiên được tớ gửi đó",
    "nay là ngày gì chắc là cậu cũng biết",
    "Thì hôm nay mình mình gửi hơi muộn",
    "8/3 luôn vui vẻ, hạnh phúc, khỏe mạnh, mọi điều tốt đẹp đến với bạn",
    "và hơn nữa sớm tìm được ngành nghề mình yếu thích"
];
